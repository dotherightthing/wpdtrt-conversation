<?php
/**
 * File: src/class-wpdtrt-conversation-plugin.php
 *
 * Plugin sub class.
 *
 * Since:
...
/**
 * Class: WPDTRT_Conversation_Plugin
 *
 ...
 *   0.9.5 - DTRT WordPress Plugin Boilerplate Generator
 */
class WPDTRT_Conversation_Plugin extends DoTheRightThing\WPDTRT_Plugin_Boilerplate\r_1_7_17\Plugin {
	 ...
	 * - add keys to wpdtrt_conversation_config (via wp_localize_script)
	 *

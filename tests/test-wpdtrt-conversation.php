<?php
/**
 * File: tests/test-wpdtrt-conversation.php
 *
 ...
 *   with the options set in wpdtrt-conversation.php
...
/**
 * Class: WPDTRT_ConversationTest
 *
 * WP_UnitTestCase unit tests for wpdtrt_conversation.
 */
class WPDTRT_ConversationTest extends WP_UnitTestCase {
	...
	public function setUp() {
		...
		$this->post_id_1 = $this->create_post( array(
			'post_title'   => 'DTRT Conversation test',
